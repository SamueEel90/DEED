...
import { Modal, QrVizual, IkonaFajka, IkonaPin, IkonaDoska, Lupa, Zdielanie, IkonaUlozit } from "./shared";
...
export function RetazDobraSheet({ odmena = 130, mode = "skutok", titulOdkaz = "Skutok", odkaz = "https://deed.app/s/120042", onClose, onDone, toast }) {
  const honorar = mode === "honorar";
  const [krok, setKrok] = useState("nastav"); // nastav | hotovo
  ...
  const inpS = { width: "100%", padding: "11px 13px 11px 38px", borderRadius: 12, background: "rgba(var(--glass-rgb),.06)", border: `1px solid ${C.line}`, color: C.text, fontSize: 14, outline: "none", fontFamily: "inherit" };
