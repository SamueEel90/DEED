...
export function CudziProfil({ subjekt = {}, onBack, toast }) {
  if (subjekt.typ === "org") return <OrgProfil s={subjekt} onBack={onBack} toast={toast} />;
  return <OsobaProfil s={subjekt} onBack={onBack} toast={toast} />;
}
...
// ============================================================
function OrgProfil({ s, onBack, toast }) {
...
// ============================================================
const STAVY = [["bezna", "Bežná"], ["priatel", "Priateľ"], ["tvorca", "Tvorca"]];

function OsobaProfil({ s, onBack, toast }) {
  // demo: prepínač stavu (v reále stav určuje vzťah + súhlas)
  const [stav, setStav] = useState(s.stav || "bezna");
