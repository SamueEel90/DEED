...
const UROVNE = [["stvrt", "Štvrť"], ["mesto", "Mesto"], ["okres", "Okres"], ["kraj", "Kraj"], ["krajina", "Krajina"]];
// demo počty v okruhu — rastú s rádiusom (placeholder, nie reálny dotaz do DB)
const POCTY_KM = { 1: [58, 9], 2: [142, 23], 3: [260, 38], 4: [410, 60], 5: [560, 82] };
const POCTY_UROVEN = { mesto: [1480, 210], okres: [5200, 640], kraj: [12800, 1500], krajina: [48000, 5200] };

export default function ModulMapa({ wide }) {
  ...
  const kruh = jeStvrt ? 64 + km * 26 : { mesto: 150, okres: 188, kraj: 216, krajina: 248 }[uroven];
