  ...
  return (
    <div style={{ paddingBottom: 24 }}>
      ...
      <div style={{ padding: "14px 18px" }}>
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 9, fontSize: 11.5, color: "var(--a-gold)", lineHeight: 1.5, margin: "16px 0 6px", padding: "11px 13px", borderRadius: 12, background: "rgba(240,199,90,.08)", border: "1px solid rgba(240,199,90,.28)" }}>
